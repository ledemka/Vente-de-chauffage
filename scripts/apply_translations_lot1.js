...
const tableData = [
  ...
  { file: 'catalogue.html', key: 'categories.1', fr: 'Bûches de bois', en: 'Firewood Logs', de: 'Brennholzscheite', nl: 'Houtblokken', fallbackEn: 'Logs' }, // Just in case
  { file: 'catalogue.html', key: 'categories.2', fr: 'Bûches compressées / briquettes de bois', en: 'Compressed Logs / Wood Briquettes', de: 'Presslinge / Holzbriketts', nl: 'Geperste blokken / Houtbriketten', fallbackEn: 'Compressed logs / wood briquettes' },
  { file: 'catalogue.html', key: 'categories.3', fr: 'Briquettes', en: 'Briquettes', de: 'Briketts', nl: 'Briketten' },
  { file: 'catalogue.html', key: 'categories.4', fr: 'Granulés / Pellets', en: 'Wood Pellets', de: 'Holzpellets', nl: 'Houtpellets', fallbackEn: 'Granules / Pellets' },
  { file: 'catalogue.html', key: 'categories.5', fr: 'Charbon / Allume-feu / Bûches de torche', en: 'Charcoal / Firelighters / Torch Logs', de: 'Kohle / Anzünder / Schwedenfackeln', nl: 'Houtskool / Aanmaakblokjes / Zweedse fakkels', fallbackEn: 'Charcoal / Kindling / Torch logs' },
  ...
  { file: 'catalogue.html', key: 'catalog.filters.format', fr: 'Format :', en: 'Format:', de: 'Format:', nl: 'Formaat:', fallbackFr: 'Format' },
  { file: 'catalogue.html', key: 'catalog.filters.format_select', fr: 'Sélectionnez un format ↑', en: 'Select a format ↑', de: 'Format auswählen ↑', nl: 'Selecteer een formaat ↑', fallbackEn: 'Select format ↑' },
  ...
  { file: 'contact.html', key: 'contact.form.honeypot', fr: 'Laissez ce champ vide', en: 'Leave this field empty', de: 'Dieses Feld leer lassen', nl: 'Laat dit veld leeg', fallbackFr: 'Leave this field empty' },
  ...
  { file: 'devis.html', key: 'quote.why.quality_desc', fr: 'Bois de qualité certifiée, taux d\'humidité garanti <20%.', en: 'Certified quality wood, guaranteed moisture level <20%.', de: 'Holz zertifizierter Qualität, garantierter Feuchtigkeitsgehalt <20%.', nl: 'Hout van gecertificeerde kwaliteit, gegarandeerd vochtgehalte <20%.', fallbackFr: 'Bois de qualité certifiée, taux d\'humidité garanti &lt;20%.' },
  ...
  { file: 'devis.html', key: 'quote.processing', fr: 'TRAITEMENT...', en: 'PROCESSING...', de: 'WIRD VERARBEITET...', nl: 'VERWERKEN...', fallbackFr: 'TRAITEMENT EN COURS...' },
  ...
  { file: 'inscription.html', key: 'register.form.type_pro', fr: 'Vous êtes professionnel (entreprise, revendeur, artisan...)', en: 'I am a business (company, reseller, tradesperson...)', de: 'Ich bin gewerblich tätig (Unternehmen, Wiederverkäufer, Handwerker...)', nl: 'Ik ben een zakelijke klant (bedrijf, wederverkoper, vakman...)', fallbackEn: 'You are a professional' },
  { file: 'inscription.html', key: 'register.form.section_business', fr: 'Informations professionnelles', en: 'Business Information', de: 'Geschäftsangaben', nl: 'Zakelijke gegevens', fallbackEn: 'Professional Information' },
...
console.log('JSON i18n files updated.');
