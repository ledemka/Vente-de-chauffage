...
<p class="font-body-lg text-body-lg text-on-surface-variant max-w-3xl">
                Chez sotramsbois, nous accordons une importance primordiale à la protection de vos données personnelles. Cette politique détaille la manière dont nous collectons, utilisons et protégeons vos informations dans le cadre de nos activités commerciales et logistiques.
            </p>
...
<p class="font-body-lg text-body-lg text-on-surface-variant max-w-2xl">
          Applicables aux transactions entre professionnels. Dernière mise à jour : Octobre 2023. Ces conditions régissent les standards de qualité, de logistique et de tarification de la biomasse sotramsbois.
        </p>
</div>
...
<p class="font-body-sm text-body-sm text-on-surface">sotramsbois se réserve le droit de déroger à certaines clauses des présentes CGV, en fonction des négociations menées avec l'acheteur, par l'établissement de Conditions Particulières de Vente.</p>
</div>
</div>
</div>
</section>
...
<div class="flex flex-col gap-4 font-body-md text-body-md text-on-surface-variant">
<p>Les produits proposés à la vente sont ceux figurant sur le catalogue B2B de sotramsbois au jour de la consultation. Les caractéristiques thermiques et dimensionnelles sont garanties dans les limites des tolérances industrielles.</p>
...
<p>Les produits livrés et conformes au bon de livraison ne sont ni repris ni échangés. En cas de non-conformité avérée lors de la livraison (vices apparents), l'acheteur doit émettre des réserves claires et précises sur le bordereau de transport et les confirmer par lettre recommandée avec AR au transporteur dans les 3 jours ouvrables suivant la réception, avec copie à sotramsbois.</p>
</div>
</div>
</section>
</div>
...
const mentionsHtml = `<!-- Mentions Légales — sotramsbois -->
<html lang="fr"><head><meta charset="utf-8"/><meta content="width=device-width, initial-scale=1.0" name="viewport"/><style>@layer base{html,body{margin:0;padding:0;}body{overscroll-behavior:none;}main>:first-child{margin-top:0!important;}main>:last-child{margin-bottom:0!important;}}::-webkit-scrollbar{display:none;}</style><link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" rel="stylesheet"/>
<link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&display=swap" rel="stylesheet"/>
...
<p class="text-body-lg font-body-lg text-on-surface-variant max-w-2xl">
                Conformément aux dispositions des articles 6-III et 19 de la Loi n° 2004-575 du 21 juin 2004 pour la Confiance dans l'économie numérique, dite L.C.E.N., nous portons à la connaissance des utilisateurs et visiteurs du site sotramsbois les informations suivantes :
            </p>
</div>
...
<span class="text-body-md font-body-md text-on-surface font-semibold">sotramsbois SAS</span>
</div>
<div class="flex flex-col gap-2">
...
<p class="text-body-md font-body-md text-on-surface-variant mb-6 leading-relaxed">
                        Le site sotramsbois est hébergé de manière sécurisée et éco-responsable. Les serveurs sont localisés sur le territoire européen, garantissant le respect strict du RGPD.
                    </p>
...
<p class="text-body-md font-body-md text-on-surface-variant leading-relaxed">
                        sotramsbois s'engage à ce que la collecte et le traitement de vos données, effectués à partir du site, soient conformes au règlement général sur la protection des données (RGPD) et à la loi Informatique et Libertés.
                    </p>
